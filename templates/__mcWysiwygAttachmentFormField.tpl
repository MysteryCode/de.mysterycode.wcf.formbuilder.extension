...
<div id="{@$field->getPrefixedID()}_uploadButton" class="formAttachmentButtons" data-max-size="{@$field->getAttachmentHandler()->getMaxSize()}" data-internal-id="{@$field->getPrefixedID()}"></div>

<script data-relocate="true">
	require(['Language', 'MysteryCode/Ui/Attachment/Upload'], function(Language, { AttachmentUpload }) {
		Language.addObject({
