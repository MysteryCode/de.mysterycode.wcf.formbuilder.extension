...
class MCI18nWysiwygFormContainer extends WysiwygFormContainer {
	 ...
	 */
	public function i18n(bool $i18n = true) : MCI18nWysiwygFormContainer {
		$this->i18n = $i18n;
	 ...
	 * @return  static                  this field
	 */
	public function i18nRequired(bool $i18nRequired = true) : MCI18nWysiwygFormContainer {
	 ...
	 */
	public function languageItemPattern(string $pattern) : MCI18nWysiwygFormContainer {
		if (!$this->isI18n()) {
			throw new \BadMethodCallException(
